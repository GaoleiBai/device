...
static int NEXCOM_CAN1_read (struct file *filp, char *buf, size_t count, loff_t *t) {
	char value;
...
static int NEXCOM_CAN1_write (struct file *filp, const char *buf, size_t count, loff_t *t) {
	char value;
